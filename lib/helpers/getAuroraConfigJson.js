...
function getAuroraConfigJSON(configFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, readFile(path_1.default.join(process.cwd(), configFile), {
                            encoding: 'utf-8'
                        })];
                case 1:
                    jsonString = _a.sent();
                ...
                case 2:
                    e_1 = _a.sent();
                    console.error("Aurora could not load ".concat(configFile, ". Please make sure this file exists and is valid."));
                    throw e_1;
                case 3: return [2];
            }
        });
...
var validateConfigurationObject = function (config, configFile) {
    var _a, _b;
    if (!Object.keys(config)) {
        console.error("Your ".concat(configFile, " is invalid or empty. Please make sure this file exists and is valid."));
